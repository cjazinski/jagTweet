...
class gsp_jagTweet_profileshow_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("profile")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.profile)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.profile),'method':("DELETE")],2)
printHtmlPart(17)
})
