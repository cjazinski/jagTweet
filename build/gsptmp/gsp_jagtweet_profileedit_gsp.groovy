...
class gsp_jagtweet_profileedit_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'profile.label', default: 'Profile'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(this.profile),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(this.profile)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(this.profile?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',32,['bean':("profile")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',37,['resource':(this.profile),'method':("PUT")],2)
printHtmlPart(24)
})
